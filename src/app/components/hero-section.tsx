...
export function HeroSection() {
    return (
        <section className="flex items-center justify-between gap-10 max-lg:flex-col-reverse max-lg:gap-6 max-lg:px-4 lg:gap-6">
            <div className="lg:w-1/2">
                ...
                <p className="py-8 leading-6 text-gray-600 max-lg:py-6">
            ...
            <div className="flex h-[400px] w-3/6 items-center justify-center bg-gray-200 max-lg:w-full">
                <ImageIcon size={80} />
            </div>
        </section>
    );
